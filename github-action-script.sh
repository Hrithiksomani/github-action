...
# Set your booker ID and authorization token for T3295004
BOOKER_ID="8feee861-9d8a-47cf-a1e3-02282423988c"
AUTH_TOKEN="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3ODg0MzE0NjZ9.evAC95X4Pdgh-yHxpz2vY0CxQssol69n9VDBw08gk7M"
...
# Target time: 23:59:00 in seconds since midnight
target_sec=$((23 * 3600 + 59 * 60 + 59))

sleep_sec=$((target_sec - now_sec))


if [ $sleep_sec -gt 0 ]; then
  echo "Sleeping for $sleep_sec seconds until 23:59:59..."
  sleep $sleep_sec
else
  echo "It's already past 23:59:59, sending requests now."
fi
